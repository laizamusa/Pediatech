...
@section('content')
    <div class="section " id="section0">
        @include('components.nav')
            ...
            <div class="intro">
                <div class="row col-md-12" style="margin-top: 85px; margin-bottom: 150px;">
                    <h1 style="text-align: center; color: #585858; margin-left: 34%;"><b>SEND US A MESSAGE</b></h1>
                    <p style="text-align: center; color: #585858; margin-left: 43%;">We want to hear from you.</p>
                    <p>&nbsp;</p>
                        ...
                        <div class="row col-md-12" style="margin-top: 85px;">
                            ...
                            <div class="col-md-6 form-captcha" style="margin-top: 31px;">
                                 <span class="your-message">
                                    <textarea style="height:188px; width: 500px; margin-left: 125px;" name="your-message" class="form-control" placeholder="Your Message"></textarea>
                                </span>
                                ...
                                <div class="row" style="margin-left: 5px;">
                                    ...
                                    <div class="col-md-6">
                                        <span class="your-captcha">
                                            <input style="width: 128px; height: 50px; margin-left: 5px;" name="your-captcha"class="form-control captchar form-control" type="text">
                                        </span>
                                    </div>
                                </div>
                            </div>
