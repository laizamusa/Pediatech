        ...
        <div class="intro">
            <div class="row" style="background-color: #d5d5d5;">
                <div class="row products_content">
                    ...
                    <p class="products_content2">PediaTech products have been developed using several patented technologies that aim to improve on currently available pediatric medicines.</br> Our technologies address various gaps in pediatric medicines including bad taste (through TasteRite technology), and proper dosing (through </br>SureDose technology). These technologies not only address children’s medicine compliance and ease of administration, but also make the lives </br> of parents and healthcare professionals easier.</p>
                </div>
            </div>
        </div>
    </div>
