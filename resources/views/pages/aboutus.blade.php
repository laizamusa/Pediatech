    ...
    <div class="intro">
        <div class="row">
            ...
            <div class="pediatech_content">
                <h1 class="pediatech_content1"><b>PEDIATECH<sup style="font-size: 17px; top: -3.5em;">TM</sup></b></h1>
                <p class="pediatech_content2">PediaTech is a research and development organization dedicated to the advancement of pediatric healthcare by developing technologies and designing products specifically catering to children, and children’s medicine-taking habits. We aim to undertake common issues with children’s medicine from bad taste to difficult dosing instructions because the best medicines in the world would not work unless the medicines are taken by the kids at the prescribed dosage level at all times.</p>
            </div>
        </div>
    </div>
    </div>
