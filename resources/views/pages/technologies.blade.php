            ...
            <div class="intro">
                ...
                <div class="row" id="zincplus">
                    ...
                    <div style="margin-left: 213px; margin-top: 100px;">
                        ...
                        <p style="text-align: center; color:#696969; font-size: 18px;">The immune system effectively defends the body against attacks by “foreign” invaders. However, there are moments </br>when the immune system weakens and fails to keep disease-causing microorganisms out. In light of this, the immune </br>system can always use a boost.</p>
                    ...
                    <p style="margin-left: 264px; text-align: center; color:#696969; font-size: 18px;">The Problem with Combining Vitamin C and Zinc</br>
                    ...
                    <p style="margin-left: 264px; text-align: center; color:#696969; font-size: 18px;">Fig. 1. Assay of Vitamin C with and without Zinc in a liquid format</p>
                    <img class="" style="height: 561px; margin-left: 22%;" src="/img/tech/zinc-plus.png">

                    <div style="margin-left: 213px; margin-top: 100px;">
                        <h1 class="eztab-title-content"><b>ZincPlus Technology</b></h1>
                        <p style="text-align: center; color:#696969; font-size: 18px;">ZincPlus is a patented technology that powers world’s only stable formulation of Vitamin C and Zinc in liquid format. It </br> uses unique polymer strands that prevent the degradation of vitamin C (Fig. 2). It also reduces the metallic taste and </br>astringency of zinc (Fig. 3). Watch the video below for more on PediaTech’s ZincPlus technology.</p>
                        <p style="text-align: center; color:#696969; font-size: 18px;">Fig. 2. Assay of Vitamin C</p>
                        <img class="" style="height: 561px; margin-left: 9%;" src="/img/tech/zinc-plus2.png">
                        <p style="margin-left: 5%; text-align: center; color:#696969; font-size: 18px;">Fig. 3 Astringency Test</p>
                        <img class="" style="height: 561px; margin-left: 9%;" src="/img/tech/zinc-plus3.png">
                    </div>
